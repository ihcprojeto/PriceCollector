            ...
            pw.TableHelper.fromTextArray(
              ...
              data: List<List<String>>.generate(data.rankingEquipe.length, (index) {
                ...
                return [
                  ...
                  user.itensColetados > 1 ? '${user.velocidadeMedia.toStringAsFixed(1)} i/h' : '--',
                  user.tempoMedio.inSeconds > 0 ? '${user.tempoMedio.inMinutes}m ${user.tempoMedio.inSeconds % 60}s' : '--',
                ];
              }),
